...
def get_town_set(use_cache=True):
    """get all valid town names"""

    # get all stations
    stations = build_station_list()

    # get set of unrepeated town names
    towns = set([station.town for station in stations if not station.town is None])
